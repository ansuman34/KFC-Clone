...
const handleAddToCart = (item) => {
    ...
    console.log(item.name, 'added to cart') // or use alert(item.name + ' added to cart')
  }
      ...
      <main>
        <section id="newchickenrolls">
          ...
          <p>Our Thai Spicy chicken roll is a delicious combination of crispy chicken, fresh vegetables
            ...
            <p>Price: ₹109.00</p>
            <button onClick={() => handleAddToCart({name: 'Thai Spicy chicken roll', price: 109.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-K973.jpg?ver=49.63" })}>Add To Cart</button>
            ...
            <p>Our Classic Chicken Roll & Pepsi Combo is a match made in heaven. Enjoy our
              ...
              <p>Price: ₹149.00</p>
              <button onClick={() => handleAddToCart({name: 'Classic Chicken Roll & Pepsi Combo', price: 149.00,img: "https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002324.jpg?ver=49.63" })}>Add To Cart</button>
              ...
              <p>Our Indian Tandoori Chicken Roll is a flavorful combination of marinated chicken,
                ...
                <p>Price: ₹129.00</p>
                <button onClick={() => handleAddToCart({name: 'Indian Tandoori Chicken Roll', price: 129.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-K975.jpg?ver=49.63" })}>Add To Cart</button>
                ...
                <p>Our Indian Spicy Veg Roll is a delicious combination of crispy vegetables, fresh
                  ...
                  <p>Price: ₹99.00</p>
                  <button onClick={() => handleAddToCart({name: 'Indian Spicy Veg Roll', price: 99.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-K976.jpg?ver=49.63" })}>Add To Cart</button>
                  ...
                  <p>Our 2 Double Chicken Roll is a mouth-watering combination of crispy chicken,
                    ...
                    <p>Price: ₹199.00</p>
                    <button onClick={() => handleAddToCart({name: '2 Double Chicken Roll', price: 199.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002316.jpg?ver=49.63" })}>Add To Cart</button>
        ...
        <p>Our 2 Chicken Longer Burgers Lunch Combo is a delicious combination of crispy chicken
          and creamy sauce, all wrapped up in a soft and fluffy bun.</p>
          <p>Price: ₹149.00</p>
          <button onClick={() => handleAddToCart({name: '2 Chicken Longer Burgers Lunch Combo', price: 149.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002503.jpg?ver=49.63" })}>Add To Cart</button>
          ...
          <p>Our new 2 Single Chicken Rolls, 4 Chicken Strips and a 1 Pepsi PET 475ml</p>
            <p>Price: ₹199.00</p>
            <button onClick={() => handleAddToCart({name: '2 Chicken Rolls Lunch Combo', price: 199.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002504.jpg?ver=49.63" })}>Add To Cart</button>
            ...
            <p> new 2 Rizo Rice Bowlz, 4 Chicken Strips and a 1 Pepsi PET 475ml.</p>
              <p>Price: ₹299.00</p>
              <button onClick={() => handleAddToCart({name: '2 Rice Bowlz Lunch Combo', price: 299.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002505.jpg?ver=49.63" })}>Add To Cart</button>
              ...
              <p>Price: ₹249.00</p>
              <button onClick={() => handleAddToCart({name: 'Chicken Longer & Rice Lunch Combo', price: 249.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002507.jpg?ver=49.63" })}>Add To Cart</button>
              ...
              <p> new 2 Chicken longer, 2 Strips, 2 HC and a Pepsi PET</p>
                <p>Price: ₹349.00</p>
                <button onClick={() => handleAddToCart({name: '2 Chicken Longer Deluxe Lunch Combo', price: 349.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002509.jpg?ver=49.63" })}>Add To Cart</button>
                </section>
        ...
        <section id="chickenbucket">
          ...
          <p>Price: ₹499.00</p>
          <button onClick={() => handleAddToCart({name: 'All in One Bucket', price : 499.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002340.jpg?ver=49.63"})}>Add To Cart </button>
          ...
          <p>Price: ₹219.00</p>
          <button onClick={() => handleAddToCart({name: 'All Chicken Box', price: 219.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002167.jpg?ver=49.63"})}>Add To Cart </button>
           ...
           <p>Price: ₹599.00</p>
           <button onClick={() => handleAddToCart({name: 'Mingles Bucket Meal', price: 599.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002162.jpg?ver=49.63"})}>Add To Cart </button>
           <h5>Big 8</h5>
           ...
           <p>Price: ₹499.00</p>
           <button onClick={() => handleAddToCart({name: 'Big 8', price: 499.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00000891.jpg?ver=49.63" })}>Add To Cart </button>
           ...
           <p>8 pc Hot & Cripsy</p>
           <p>Price: ₹449.00</p>
           <button onClick={() => handleAddToCart({name: '8 pc Hot & Crispy Chicken', price:499.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-K009.jpg?ver=49.63"})}>Add To Cart </button>
           ...
           <p>Price: ₹299.00</p>
           <button onClick={() => handleAddToCart({name: '5 pc Peri Peri Leg, Reg Popcorn, Med Fries', price: 299.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002156.jpg?ver=49.63"})}>Add To Cart </button>
        </section>
        <section id="burgers">
          <h1>Burgers</h1>
          ...
          <p>Spicy Zinger Fillet, topped with melted cheese, lettuce, tomato,
            ...
            <p>Price: ₹299.00</p>
            <button onClick={() => handleAddToCart({name: 'Mexican Zinger Pro Burger',price: 299,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-K696.jpg?ver=49.63"})}>Add To Cart</button>
            ...
            <p>Indian-style Zinger Burger with a crispy Paneer patty, topped with melted
              ...
              <p>Price: ₹249.00</p>
              <button onClick={() => handleAddToCart({name: 'Indian Paneer Zinger Burger',price: 249.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-K912.jpg?ver=49.63"})}>Add To Cart</button>
              ...
              <p>Price: ₹439.00</p>
              <button onClick={() => handleAddToCart({name: 'Caribbean Spicy Zinger Burger & Popcorn Meal',price: 439.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002412.jpg?ver=49.63"})}>Add To Cart</button>
              ...
              <p>Price: ₹459.00</p>
              <button onClick={() => handleAddToCart({name: 'Mexican Zinger Pro Burger & Popcorn Meal',price: 459.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00002415.jpg?ver=49.63"})}>Add To Cart</button>
              ...
              <p>Price: ₹299.00</p>
              <button onClick={() => handleAddToCart({name: 'Caribbean Spicy Zinger Burger',price: 299.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-K815.jpg?ver=49.63"})}>Add To Cart</button>
              ...
              <p>Price: ₹199.00</p>
              <button onClick={() => handleAddToCart({name: '2 Chicken Krisper Burgers',price: 199.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00001025.jpg?ver=49.63"})}>Add To Cart</button>
        ...
        <section id="snacks">
          ...
          <p>Price: ₹49.00</p>
          <button onClick={() => handleAddToCart({name: 'Chocolate Lava Cake',price: 49.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-K701.jpg?ver=49.63"})}>Add To Cart</button>
          ...
          <p>Price: ₹299.00</p>
          <button onClick={() => handleAddToCart({name: 'Chicken & Fries Bucket',price: 299.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-PR00000789.jpg?ver=49.63"})}>Add To Cart</button>
          ...
          <p>Price: ₹149.00</p>
          <button onClick={() => handleAddToCart({name: 'Regular Popcorn',price: 149.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-K136.jpg?ver=49.63"})}>Add To Cart</button>
        </section>
        <section id="beverages">
          ...
          <p>Price: ₹25.00</p>
          <button onClick={() => handleAddToCart({name: 'Pepsi 475ml PET',price: 25.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-K350.jpg?ver=49.63"})}>Add To Cart</button>
          ...
          <p>Price: ₹20.00</p>
          <button onClick={() => handleAddToCart({name: '7UP Can 300 ml',price: 20.00,img:"https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/items/xl/D-K487.jpg?ver=49.63"})}>Add To Cart</button>
